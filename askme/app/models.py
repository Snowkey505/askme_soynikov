...
class ProfileManager(models.Manager):
    def best(self):
        return self.annotate(answer_likes=Count('answers__likes')).order_by('-answer_likes')[:5]
...
class Question(models.Model):
    ...
    image = models.ImageField(blank=True, null=True, default='static/img/avatar_dark.png')
...
class AnswerLike(models.Model):
    ...
    def __str__(self):
        return f"{self.user} liked answer to '{self.answer.question}'"
